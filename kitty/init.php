...
/*	$arrClassesMap = array( 
	...
	//\kitty\base\autoload::loadmap($arrClassesMap);

	// \kitty\base\Autoload::addPath( doc_root ."/app/common/models/");
	
	
	// Регестрируем пути в которых искать класс
	//autoload::addPath('/framework/models');  // Базовые модели
	//\kitty\base\autoload::addPath('/framework/vendors'); 
